...
=======
                tlc5947[x] = round((((line[x] - velMin) * (PWMMax )) / (velMax - velMin)) + notesMinDict[x] - 526)
                print(round((((line[x] - velMin) * (PWMMax )) / (velMax - velMin)) + notesMinDict[x] - 526))
>>>>>>> parent of f737efe (Update play_midi.py)
            else:
                tlc5947[x] = 0
                continue
        tlc5947.write()
        # time.sleep(tickLength)
        print("Sent Array to PWM IC")
